    ...
    <main id="main" className="text-lg">
      ...
      <div className="container mx-auto flex flex-col justify-center px-3 py-10 xl:max-w-screen-xl">
        ...
        <p className="mt-10">
          ...
          reasons. By no means will the collected data be sold or for any other
          reason given to third parties. The following statement gives you an
          overview of how we ensure this protection and what kind of data is
          being collected for what purpose.
        </p>
        ...
        <p className="mt-5">
          ...
          time whether you would like to continue with an instruction prompting
          you to provide information. In some cases, you will be unable to
          complete a particular step in the process if you do not want to
          provide the information requested. For example, we will ask for
        ...
        <p className="mt-5">
          ...
          your browser. Cookies are loaded on your browser when you first use a
          product or service.
        </p>
        <p className="mt-5">
          Cookies do not include any personal information. We may use cookies to
          identify the browser you are using so that our website displays
          ...
          allow for a more efficient website design. If you do not want to allow{" "}
          {companyName} or someone else to use cookies, you can disable cookie
          installation via your browser setting. While you also have the option
          of deleting cookies from your computer’s hard disk at any time, if you
          choose to do so, you may be unable to use some of the features of our
          website, products and services.
        </p>
        <p className="mt-10 text-xl font-bold">Google Analytics</p>
        <p className="mt-5">
          {companyName} uses the following third-party analytics tools to better
          understand your interaction with our website and use of our
          products/services. Our ultimate goal is to create a more user-friendly
          experience for you:
        </p>
        <p className="mt-5">
          ...
          anonymize IP process) if located within a member state of the European
          Union or in other contracting member states to the Agreement on the
          European Economic Area. The entire IP address is transferred to a
          Google server in the USA and saved there only in exceptional cases.
        </p>
        <p className="mt-5">
          This anonymization ensures that your IP address cannot be traced back
          to you. Google will use this information to evaluate your use of the
          website in order to compile reports about website activities for{" "}
          {companyName} and provide additional services associated with website
          and Internet usage. Google can transfer this information to third
          parties, where appropriate, if legally mandated or if Google contracts
          with third parties to process such data. Google will not associate
          your IP address with other Google data. By using our website, you
          expressly consent to Google’s collection and storage of your data in
          the manner and for the purposes described above. You also have the
          option to prevent Google from acquiring and processing data generated
          by Cookies and data related to your use of our website (including your
          IP address) by downloading and installing a Google-provided browser
          plugin.
        </p>
